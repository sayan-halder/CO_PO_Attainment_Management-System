...
public class Subject_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sub_name.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        sub_name.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sub_code, javax.swing.GroupLayout.DEFAULT_SIZE, 430, Short.MAX_VALUE)
                            .addComponent(sub_name)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnregister)
                        .addGap(18, 18, 18)
                        .addComponent(btnclear, javax.swing.GroupLayout.DEFAULT_SIZE, 293, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisterActionPerformed
        try
        {
            pstmt=conn.prepareStatement("insert into SUBJECT (SUBJECT_CODE, SUBJECT_NAME) values (?,?)");
            pstmt.setString(1,sub_code.getText());
            pstmt.setString(2,sub_name.getText());
            pstmt.execute();
